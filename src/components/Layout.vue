<template>
  <div @click="restComponent">
    <!-- 头部 -->
      ...
      <!-- 注册弹出窗 -->
      <my-dialog @on-close="closeDialog('isShowLogDialog')" :is-show="isShowLogDialog">
        <log-from @has-log="onSuccessLog"></log-from>
      </my-dialog>
      <!-- 登陆弹出窗 -->
      <my-dialog @on-close="closeDialog('isShowRegDialog')" :is-show="isShowRegDialog">
...
export default {
  ...
  methods: {
    ...
    onSuccessLog(username, password) {
